...
clicking 'Ctrl-P' and
to take over the meticulous process of optimizing the design and print process 
settings from the
user. To do so, we propose to develop a digital twin to exactly monitor the 
...
largeparts
of the actual design process (dashed line) in order to allow for the direct manufacturing 
of a brilliant idea.
</div>
